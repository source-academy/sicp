...
const createIndexHtml = version => {
  ...
  stream.once("open", fd => {
    if (version === "split") {
      ...
      stream.write(
        `<!doctype html><html lang="en"><body><A HREF="https://source-academy.github.io/interactive-sicp">Go to the new <B>Interactive SICP</B></A><br/><br/><A HREF="oldindex.html">...or go to the old Mobile-friendly Web Edition</A></body></html>`
      );
